    ...
    <div>
      ...
      <div className='flex w-full h-[110px] px-36 justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
        ...
        <ul className='flex space-x-16 hidden md:flex'>
          <li>
            <Link className="text-2xl border-b-2 border-transparent hover:text-red-800 dark:hover:text-red-200 hover:border-red-500" to='home' smooth={true} duration={500}>
              Home
            </Link>
          </li>
          <li>
            <Link className="text-2xl border-b-2 border-transparent hover:text-red-800 dark:hover:text-red-200 hover:border-red-500" to='about' smooth={true} duration={500}>
              About
            </Link>
          </li>
          <li>
            <Link className="text-2xl border-b-2 border-transparent hover:text-red-800 dark:hover:text-red-200 hover:border-red-500" to='skills' smooth={true} duration={500}>
              Skills
            </Link>
          </li>
          <li>
            <Link className="text-2xl border-b-2 border-transparent hover:text-red-800 dark:hover:text-red-200 hover:border-red-500" to='work' smooth={true} duration={500}>
              Work
            </Link>
          </li>
          <li>
            <Link className="text-2xl border-b-2 border-transparent hover:text-red-800 dark:hover:text-red-200 hover:border-red-500" to='contact' smooth={true} duration={500}>
              Contact
            </Link>
          </li>
        </ul>
